...
func (ch *CMHandlers) registerResourceHandlers(a *MetricsAPIInstaller, ws *restful.WebService) error {
	...
	rootScopedHandler := metrics.InstrumentRouteFunc("LIST", "custom-metrics", "", "cluster", restfulListResourceWithOptions(lister, nil, reqScope, false, a.minRequestTimeout))
	...
	namespacedHandler := metrics.InstrumentRouteFunc("LIST", "custom-metrics-namespaced", "", "namespace", restfulListResourceWithOptions(lister, nil, reqScope, false, a.minRequestTimeout))
	...
	namespaceSpecificHandler := metrics.InstrumentRouteFunc("LIST", "custom-metrics-for-namespace", "", "cluster", restfulListResourceWithOptions(lister, nil, reqScope, false, a.minRequestTimeout))
